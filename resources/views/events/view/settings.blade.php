    ...
    <div class="row">
        <div class="col-md-7">
            <fieldset>
                ...
                {{-- Event client --}}
                <div class="form-group @InputClass('client_type')" data-visibility-input="type" data-visibility-value="{{ \App\Event::TYPE_EVENT }}">
                ...
                {{-- Venue type --}}
                <div class="form-group @InputClass('venue_type')" data-visibility-input="type" data-visibility-value="{{ \App\Event::TYPE_EVENT }}">
                    ...
                    @else
                        <p class="form-control-static">{{ \App\Event::$VenueTypes[$event->venue_type] }}</p>
                    @endcan
                </div>
                {{-- Venue --}}
        ...
        <div class="col-md-5">
            <fieldset>
                ...
                <div class="form-group @InputClass('crew_list_status')">
                    ...
                    {!! Form::select('crew_list_status', \App\Event::$CrewListStatus, null, ['class' => 'form-control']) !!}
                    <p class="help-block small">
                        <a data-toggle="modal" data-target="#modal" data-modal-template="crew_list_help" data-modal-class="modal-sm" href="#">What does this
                            mean?</a>
                    </p>

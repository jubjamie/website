...
class CrewController extends Controller
{
    ...
    private function storeGuest(Event $event, Request $request)
    {
        // Validate
        $fields = ['guest_name'];
        $this->validate($request, EventCrew::getValidationRules($fields), EventCrew::getValidationMessages($fields));
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    private function updateField(EventCrew $crew, Request $request)
    {
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    private function updateGuest(EventCrew $crew, Request $request)
    {
        // Validate
        $fields = ['guest_name'];
        $this->validate($request, EventCrew::getValidationRules($fields), EventCrew::getValidationMessages($fields));
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    private function updateMember(EventCrew $crew, Request $request)
    {
        // Validate
        $fields = ['name'];
        $this->validate($request, EventCrew::getValidationRules($fields), EventCrew::getValidationMessages($fields));

...
class ElectionController extends Controller
{
    ...
    public function index()
    {
        ...
        $elections = Election::orderBy('voting_start', 'DESC')
                             ->paginate(10);
        $this->checkPagination($elections);
    ...
    public function create(Request $request)
    {
        ...
        $positions = CommitteeRole::orderBy('order', 'ASC')
                                  ->pluck('name', 'id');
    ...
    public function update($id, ElectionRequest $request)
    {
        ...
        Notifications::success('Election updated');
    ...
    public function destroy($id)
    {
        ...
        Notifications::success('Election deleted');
    ...
    public function elect($id, Request $request)
    {
        ...
        Notifications::success('Committee saved');
        return $this->ajaxResponse(true);
    }

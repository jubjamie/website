...
{
    use Validatable, ChecksJoins, DistinctPaginate {
    ...
    {
        return $this->hasMany('App\EventEmail')
    ...
    {
        if($this->type == static::TYPE_EVENT && env('APP_ENV') == 'production') {
            $fields       = [
